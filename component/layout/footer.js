                                        ...
                                        <div className="footer__newsletter--form">
                                            <form action="#">
                                                <input 
                                                    ...
                                                    id="item01"
                                                    value={newsEmail}
                                                    onChange={(e)=>{setNewsEmail({newsEmail: e.target.value});}}
                                        ...
                                        <div className="footer__newsletter--social">
                                            <ul>
                                                {SocialList.map((val, i) => (
                                                    <li key={i}><Link href={`${val.visitLink}`}><i className={`${val.iconName}`}></i></Link></li>
                                                ))}
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div className="footer__inner">
                                            <div className="footer__content">
                                                ...
                                                <div className="footer__content--desc">
                                                    <ul>
                                                        {InfoList.map((val, i) => (
                                                            <li key={i}><Link href={val.pageLink}><i className="fa-solid fa-angle-right"></i> {val.pageName}</Link></li>
                                                        ))}
                                                    </ul>
                                                </div>
                                            </div>
                ...
                <div className="footer__bottom wow fadeInUp" data-wow-duration="1.5s">
                    <div className="container">
                        <div className="footer__content text-center">
                            <p className="mb-0">All Rights Reserved &copy; <Link href="/"> Istiaq Ahmed </Link> || Design By: Zenith</p>
                        </div>
                    </div>
                </div>
            </footer>
