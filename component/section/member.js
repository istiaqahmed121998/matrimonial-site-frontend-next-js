      ...
      <div className="container">
        ...
        <div className="section__wrapper wow fadeInUp" data-wow-duration="1.5s">
          <ul className="member__buttongroup filters-button-group w-100 d-flex flex-wrap justify-content-center">
            <li
              onClick={() => setItems(MemberDataList)}
              className="button filter-btn"
            >
              <span className="member__radio"></span> View All{" "}
            ...
            <li
              ...
              className="button filter-btn"
            >
              <span className="member__radio"></span> Male{" "}
              <span className="banner__inputlist--icon">
          ...
          <div className="text-center mt-4">
            <Link href="/members" className="default-btn">
              <span>{btnText}</span>
            </Link>
          </div>
        </div>
